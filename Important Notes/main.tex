...
\subsection{Visual Geometry Group 16(VGG16)}
\noindent
\begin{center}
    \fcolorbox{blue}{blue!10}{
        \parbox{0.95\linewidth}{
            \textbf{Definition:} \\
           VGG16 (Visual Geometry Group 16) is a deep convolutional neural network architecture, renowned for its simplicity and effectiveness in image recognition tasks.
        }
    }
\end{center}
